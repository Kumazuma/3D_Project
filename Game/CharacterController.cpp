...
/////Support jumping
/////Support ducking
//class CharacterClosestNotMeRayResultCallback : public btCollisionWorld::ClosestRayResultCallback
//{
//public:
//	CharacterClosestNotMeRayResultCallback(btCollisionObject* me) : btCollisionWorld::ClosestRayResultCallback(btVector3(0.0, 0.0, 0.0), btVector3(0.0, 0.0, 0.0))
//	{
//		m_me = me;
//	}
//
...
//};
//
//class CharacterClosestNotMeConvexResultCallback : public btCollisionWorld::ClosestConvexResultCallback
//{
//public:
//	CharacterClosestNotMeConvexResultCallback(btCollisionObject* me, const btVector3& up, btScalar minSlopeDot)
...
//}
//
//CharacterController::CharacterController(btRigidBody* rigidBody, btConvexShape* convexShape, btScalar stepHeight, const btVector3& up)
//{
...
//	m_convexShape->getAabb(m_rigidBody->getWorldTransform(), minAabb, maxAabb);
//	collisionWorld->getBroadphase()->setAabb(m_rigidBody->getBroadphaseHandle(),
//		minAabb,
//		maxAabb,
...
//
//	
//	collisionWorld->getDispatcher()->dispatchAllCollisionPairs(m_rigidBody->getOverlappingPairCache(), collisionWorld->getDispatchInfo(), collisionWorld->getDispatcher());
//
//	m_currentPosition = m_rigidBody->getWorldTransform().getOrigin();
//
...
//		}
//	}
//	btTransform newTrans = m_rigidBody->getWorldTransform();
...
//
//	CharacterClosestNotMeConvexResultCallback callback(m_rigidBody, -m_up, m_maxSlopeCosine);
//	callback.m_collisionFilterGroup = GetRigidBody()->getBroadphaseHandle()->m_collisionFilterGroup;
//	callback.m_collisionFilterMask = GetRigidBody()->getBroadphaseHandle()->m_collisionFilterMask;
//
//	if (m_useGhostObjectSweepTest)
//	{
//		//m_rigidBody->get
//		m_rigidBody->convexSweepTest(m_convexShape, start, end, callback, world->getDispatchInfo().m_allowedCcdPenetration);
//	}
//	else
//	{
...
//		end.setRotation(m_targetOrientation);
//
//		CharacterClosestNotMeConvexResultCallback callback(m_ghostObject, sweepDirNegative, btScalar(0.0));
...
//}
//
//void CharacterController::setAngularVelocity(const btVector3& velocity)
//{
//	m_AngVel = velocity;
//}
//
//const btVector3& CharacterController::getAngularVelocity() const
//{
//	return m_AngVel;
//}
//
//void CharacterController::setLinearVelocity(const btVector3& velocity)
//{
//	m_walkDirection = velocity;
//
...
//}
//
//btVector3 CharacterController::getLinearVelocity() const
//{
...
//}
//
//void CharacterController::setMaxPenetrationDepth(btScalar d)
//{
